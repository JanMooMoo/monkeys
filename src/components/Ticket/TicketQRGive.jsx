...
class TicketQRGive extends Component {
    constructor(props, context) {
		...
		this.event = this.contracts['Kadena'].methods.callForHelpDetails.cacheCall(this.props.ticket.returnValues.eventId);
		this.address = null;
		this.state = {
			loading: false,
			loaded: false,
	...
	updateIPFS = () => {
        console.log(this.state.loaded, this.state.loading,typeof this.props.contracts['Kadena'].callForHelpDetails[this.event])
